...
| Score scale | 1–10 | per user's `scoreFormat` (`POINT_100`/`POINT_10[_DECIMAL]`/`POINT_5`/`POINT_3`) | 1 to 10 integer (0 clears) | 1 to 10 integer (`/sync/ratings`, remove via `/sync/ratings/remove`) |
